...
/**
 * Shareable result card (Phase 3, plan §10.3). Rendered on a canvas, not an
 * SVG converted to an image, so the loaded web fonts (Plex Mono, EB Garamond) draw reliably
